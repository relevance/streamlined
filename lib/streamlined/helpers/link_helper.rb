...
module Streamlined::Helpers::LinkHelper
  def link_to_new_model
    link_to_function image_tag('add_16.png', 
  ...
  def link_to_xml_export
    link_to_function(image_tag('export_16.png', 
  ...
  def link_to_previous_page
    link_to_function image_tag('control-forward_16.png', 
